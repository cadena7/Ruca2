...
RUEDA_MOTOR.setSpeed(20)          # 60 RPM
POLARIZA_MOTOR.setSpeed(20)          # 60 RPM
...
def FirstinitPos():
    ...
    while variables.FIRST_INIT_RUEDA != 1:
        ...
        #RUEDA_MOTOR.oneStep(Adafruit_MotorHAT.FORWARD,  Adafruit_MotorHAT.SINGLE)
    ...
    RUEDA_FRENO_OUT_PWM.ChangeDutyCycle(0)
    time.sleep(2)
    while ruedapasosextra < 12 and ruedacompletado != 0:
        ruedapasosextra += 1
        time.sleep(0.40)
    ...
    POLARIZA_FRENO_OUT_PWM.ChangeDutyCycle(0)
    time.sleep(2)
    while polarizapasosextra < 12 and polarizacompletado != 0:
            ...
            if comando == 'REDUCTOR':           #EJEMPLO: echo REDUCTOR 1 | nc ip 6666  (del 1 al 3)
                ...
                if variables.RUEDA_INDICE_SET >= 1 and variables.RUEDA_INDICE_SET <= 8:
                    ...
                    if rueda_dif == -4 or rueda_dif == -3 or rueda_dif == -2 or rueda_dif == -1 or rueda_dif == 4 or rueda_dif == 5 or rueda_dif == 6:
                        ...
                        RUEDA_FRENO_OUT_PWM.ChangeDutyCycle(0)
                        time.sleep(2)
                        while self.pasosextra < 12 and self.completado != 0:
                            self.pasosextra += 1
                            time.sleep(0.40)
                            if variables.RUEDA_FRENO_SENSOR == 0:
                                RUEDA_FRENO_OUT_PWM.ChangeDutyCycle(100)
